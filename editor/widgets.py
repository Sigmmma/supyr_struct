...
class BlockWidget():
    ...
    def __init__(self, *args, **kwargs):
        ...
        if 'pad_l' in kwargs: self.pad_l = kwargs['pad_l']
        if 'pad_r' in kwargs: self.pad_r = kwargs['pad_r']
        if 'pad_t' in kwargs: self.pad_t = kwargs['pad_t']
        if 'pad_b' in kwargs: self.pad_b = kwargs['pad_b']
